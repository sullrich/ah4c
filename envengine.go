...
var varCatalog = []VarSpec{
	...
	{Key: "STREAMER_APP", Label: "Streaming app scripts", Desc: "Choose the scripts ah4c should use to open your streaming app, switch channels, and stop playback. You do not need to read or edit the scripts.", Placeholder: "scripts/my-device/my-app", Type: varEnum, Applies: applyRestart},
